({
    getOpportunityList : function(component, event, helper) {
        helper.fetchOpportunityList(component,event,helper);
    },
    ...
    sortByDate: function(component, event, helper) {
        helper.sortBy(component,helper, "Contract_Sent_Date__c");
        var a=component.get("v.sortAsc");
        component.set("v.Date",a);
    },
    
    sortBySignedDate: function(component, event, helper) {
        helper.sortBy(component,helper, "Contract_Signed_Date__c");
        var a=component.get("v.sortAsc");
        component.set("v.SignedDate",a);
    },
    
    sortByStage: function(component, event, helper) {
        helper.sortBy(component,helper, "StageName");
        var a=component.get("v.sortAsc");
    ...
    handleViewAll: function (component, event, helper) {
        ...
        const url = `/lightning/n/NCM_Group_Status_Report?c__accountId=${accountId}`;
