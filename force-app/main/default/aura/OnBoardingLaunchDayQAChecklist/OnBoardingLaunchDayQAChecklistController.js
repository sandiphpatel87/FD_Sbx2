({
    doInit: function (component, event, helper) {  
        debugger
       // var strLabel = "Create AWCT Conversions for New/Used SRP and VDP Views - Instructions found"+/<a href="#">here </a>'
        ...
        action.setCallback(this, function(response) {  
           ...
           if (state === "SUCCESS") {
                ...
                toastEvent.setParams({
                    title : 'Success',
                    message: 'Launch Day QA Checklist has been successfully updated' ,
                    duration:' 4000',
                    key: 'info_alt',
                    type: 'success',
                    mode: 'pester'
